...
- (UIBarButtonItem *)menuBarButtonItem {
    ...
    customButtonView.frame      = CGRectMake(0, 0, 37.5, 30);
    [customButtonView addTarget:self action:@selector(toggleSideMenuPressed:) forControlEvents:UIControlEventTouchUpInside];
    [customButtonView setBackgroundImage: [UIImage imageNamed:@"ListBrown@2x.png"] forState:UIControlStateNormal];
    
    [menuButton setCustomView:customButtonView];
