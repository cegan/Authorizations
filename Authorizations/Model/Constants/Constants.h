...
extern int const kAchDetailsTotalRowsWithErrors;
extern int const kTableViewSectionHeaderHeightVisible;
extern int const kTableViewSectionHeaderHeightHidden;
