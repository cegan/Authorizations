...
namespace MoonAPNS
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            var payload1 = new NotificationPayload("ec2c9674 df4a2f1b c080f911 464a88bd 682fd7c9 76573d2e 5534f812 b2ecf41c", "Test", 1, "default");
            payload1.AddCustom("RegionID", "IDQ10150");

            var p = new List<NotificationPayload> {payload1};

            var push = new PushNotification(true, "Authorizations","LiveWire69");
