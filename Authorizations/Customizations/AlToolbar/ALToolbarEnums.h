...
enum ALToolbarAnimationDirection{
    ALToolbarAnimationDirectionLeft,
    ALToolbarAnimationDirectionRight,
    ALToolbarAnimationDirectionBottom,
    ALToolbarAnimationDirectionTop
};

enum ALToolbarAnimationType{
    ALToolbarAnimationTypeSlide,
    ALToolbarAnimationTypeFade
};

enum ALToolbarButtonsLayoutMode{
    ALToolbarButtonsLayoutModeAutoCenter,
    ALToolbarButtonsLayoutModeAutoCenterHorizontal,
    ALToolbarButtonsLayoutModeAutoCenterVertical,
    ALToolbarButtonsLayoutModeManual
};